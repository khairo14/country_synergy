...
// dashboard
Route::view('/home/scan','/scan/scanIn');


// freezer locations
Route::get('/location',[LocationController::class,'fLocation'])->name('location');
Route::post('/location/add',[LocationController::class,'addLocation'])->middleware('auth');
Route::post('/location/edit',[LocationController::class,'editLocation'])->middleware('auth');
Route::post('/location/import',[LocationController::class,'locationImport'])->middleware('auth');
