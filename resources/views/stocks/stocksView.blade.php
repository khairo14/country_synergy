...
<div class="grid w-full grid-cols-1 mt-1 sm:grid-cols-1 p-2 sm:w-full">
    <div class="grid grid-cols-1 px-4 overflow-none bg-white rounded-lg shadow sm:p-6">
        <div class="overflow-hidden shadow ring-1 w-full rounded-lg ring-black ring-opacity-5 md:rounded-lg">
            <div class="grid grid-cols-4 px-4 py-5 overflow-none bg-gray-200 rounded-lg shadow sm:p-6">
                <div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" id="srch_date" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 block w-64 pl-10 py-1" placeholder="Select Date">
                    </div>
                </div>
