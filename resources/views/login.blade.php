...
<div class="flex items-center justify-center min-h-full px-4 py-12 sm:px-6 lg:px-8">
    <div class="w-full max-w-md space-y-8">
      <div>
        ...
        <h2 class="mt-6 text-3xl font-extrabold text-center text-gray-900">Country Synergy</h2>
      </div>
